#USAGE: python3 pdfParanoia.py <password>
import os
...
# password = 'Password1!'
pdfList = []
for folderName, subFolder, filenames in os.walk('/home/shrisharanyan/AutomateTheBoringStuff/15_WorkingWithPDFAndWordDocuments/'):
